...
function PlayerPhoto({ slotId, size = 96 }) {
  ...
  return <image-slot id={slotId} shape="rounded" radius="14" placeholder={ro ? 'Photo' : 'Drop photo'} style={{ width:size, height:size, flex:'none', ...(ro ? { pointerEvents:'none' } : {}) }}></image-slot>;
}
